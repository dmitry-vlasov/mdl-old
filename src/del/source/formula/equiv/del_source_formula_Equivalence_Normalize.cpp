...
#ifndef DEL_SOURCE_FORMULA_EQUIVALENCE_NORMALIZE_CPP_
#define DEL_SOURCE_FORMULA_EQUIVALENCE_NORMALIZE_CPP_
...
#endif /*DEL_SOURCE_FORMULA_EQUIVALENCE_NORMALIZE_CPP_*/
