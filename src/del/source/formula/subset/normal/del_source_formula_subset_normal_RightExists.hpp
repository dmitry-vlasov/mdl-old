...
#ifndef DEL_SOURCE_FORMULA_SUBSET_NORMAL_RIGHT_EXISTS_HPP_
#define DEL_SOURCE_FORMULA_SUBSET_NORMAL_RIGHT_EXISTS_HPP_
...
#endif /*DEL_SOURCE_FORMULA_SUBSET_NORMAL_RIGHT_EXISTS_HPP_*/
