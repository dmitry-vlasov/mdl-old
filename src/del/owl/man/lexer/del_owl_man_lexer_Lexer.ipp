...
/* File Name:       del_owl_man_lexer_Lexer.ipp                              */
...
using manipulator :: endLine;
	...
	inline void
	Lexer :: setIdleScan (const bool idleScan) {
		idleScan_ = idleScan;
	}
	inline void
	Lexer :: scanUpToEmptyLine() {
		scaner_.scanUpToEmptyLine();
	}

	inline value :: Relation
	...
	inline value :: Theory
	Lexer :: scanTheoryName()
	{
		scan();
		return Table :: theories()->add (getToken());
	}
