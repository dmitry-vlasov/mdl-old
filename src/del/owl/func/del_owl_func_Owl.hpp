...
/* File Name:       del_owl_func_Owl.hpp                                     */
/* Description:     functional OWL2 translator to del                        */
...
#ifndef DEL_OWL_FUNC_OWL_HPP_
#define DEL_OWL_FUNC_OWL_HPP_
