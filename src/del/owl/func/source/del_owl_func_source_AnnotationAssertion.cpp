...
#ifndef DEL_OWL_FUNC_SOURCE_ANNOTATION_ASSERTION_CPP_
#define DEL_OWL_FUNC_SOURCE_ANNOTATION_ASSERTION_CPP_
...
#endif /*DEL_OWL_FUNC_SOURCE_ANNOTATION_ASSERTION_CPP_*/
