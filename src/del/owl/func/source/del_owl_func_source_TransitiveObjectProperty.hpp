...
#ifndef DEL_OWL_FUNC_SOURCE_TRANSITIVE_OBJECT_PROPERTY_HPP_
#define DEL_OWL_FUNC_SOURCE_TRANSITIVE_OBJECT_PROPERTY_HPP_
...
#endif /*DEL_OWL_FUNC_SOURCE_TRANSITIVE_OBJECT_PROPERTY_HPP_*/
