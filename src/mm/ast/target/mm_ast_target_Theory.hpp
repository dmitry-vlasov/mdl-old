...
/* File name:       mm_ast_target_Theory.hpp                                 */
...
#ifndef MM_AST_TARGET_THEORY_HPP_
#define MM_AST_TARGET_THEORY_HPP_
...
class Theory :
	public mm :: object :: Referable,
	public Scalar<Theory> {
public :
	Theory (const mm :: source :: Include* const);
	virtual ~ Theory();
...
#endif /*MM_AST_TARGET_THEORY_HPP_*/
