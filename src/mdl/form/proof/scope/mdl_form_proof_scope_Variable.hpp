...
/* File Name:       mdl_form_proof_scope_Variable.hpp                        */
...
#ifndef MDL_FORM_PROOF_SCOPE_VARIABLE_HPP_
#define MDL_FORM_PROOF_SCOPE_VARIABLE_HPP_
...
public :
	Variable (mdl :: proof :: Scope*, mdl :: proof :: Variable*);
	virtual ~ Variable();
...
#endif /*MDL_FORM_PROOF_SCOPE_VARIABLE_HPP_*/
