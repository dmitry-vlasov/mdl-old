...
#ifndef MDL_EXPRESSION_UNIFY_EXP_SUBSTIRATOR_SYM_HPP_
#define MDL_EXPRESSION_UNIFY_EXP_SUBSTIRATOR_SYM_HPP_
...
#endif /*MDL_EXPRESSION_UNIFY_EXP_SUBSTIRATOR_SYM_HPP_*/
