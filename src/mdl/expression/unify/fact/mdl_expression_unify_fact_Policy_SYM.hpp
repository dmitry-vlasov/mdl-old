...
/* File name:       mdl_expression_unify_fact_Policy_SYM.hpp                 */
...
#ifndef MDL_EXPRESSION_UNIFY_FACT_POLICY_SYM_HPP_
#define MDL_EXPRESSION_UNIFY_FACT_POLICY_SYM_HPP_
...
public :
	...
	unifyThis (Unit_ unit) {
		return Unifier_ :: unifyNode (unit);
	}
};
...
public :
	...
	inline static Result_
	unifyThis (Unit_ unit) {
		return Unifier_ :: unifyNode (unit.inverse());
	}
};
...
#endif /*MDL_EXPRESSION_UNIFY_FACT_POLICY_SYM_HPP_*/
