...
#ifndef MDL_EXPRESSION_ITERATOR_CONSTANT_LINEAR_HPP_
#define MDL_EXPRESSION_ITERATOR_CONSTANT_LINEAR_HPP_
...
#endif /*MDL_EXPRESSION_ITERATOR_CONSTANT_LINEAR_HPP_*/
