...
#ifndef MDL_EXPRESSION_ITERATOR_CONSTANT_SINGLETON_HPP_
#define MDL_EXPRESSION_ITERATOR_CONSTANT_SINGLETON_HPP_
...
#endif /*MDL_EXPRESSION_ITERATOR_CONSTANT_SINGLETON_HPP_*/
