...
/* File name:       mdl_expression_iterator_Singleton.ipp                    */
...
#ifndef MDL_EXPRESSION_ITERATOR_SINGLETON_IPP_
#define MDL_EXPRESSION_ITERATOR_SINGLETON_IPP_
...
namespace iterator {
	...
	template<class N>
	inline
	Singleton<N> :: Singleton (Node_* node) :
	node_ (node) {
	}
	template<class N>
	inline
	...
	template<class N>
	inline void
	Singleton<N> :: operator = (const Node_* pointer) {
		node_ = pointer;
	}
	...
	template<class N>
	inline bool
	Singleton<N> :: operator == (const typename constant :: Singleton<N>& iterator) const {
		return node_ == iterator.node_;
	}
	template<class N>
	inline bool
...
#endif /*MDL_EXPRESSION_ITERATOR_SINGLETON_IPP_*/
