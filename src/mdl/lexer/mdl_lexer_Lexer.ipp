...
using manipulator :: endLine;
	...
	{
		scan<Token :: NUMBER>();
		return getToken().getIntegerValue<T>();
	}
	inline value :: Real
	Lexer :: scanReal()
	{
		scan<Token :: REAL_NUMBER>();
		return getToken().getDoubleValue();
	}
	inline value :: Name
	Lexer :: scanName()
	{
		scan<Token :: NAME>();
		return Table :: names()->add (getToken());
	}
	inline value :: Literal
	Lexer :: scanLiteral()
	{
		scan<Token :: LITERAL>();
		return Table :: literals()->add (getToken());
	}
	inline value :: Literal
	Lexer :: scanLiteralName()
	{
		scan<Token :: NAME>();
		return Table :: literals()->add (getToken());
	}
...
using manipulator :: space;
	...
	Lexer :: getLocation()
	{
		Location& location = source_.location();
		if (isTop()) {
			location.markupPosition();
		}
		return location;
	}
	...
	Token :: Type Lexer :: scan ()
	{
		...
		default :
			...
			error->message() << Token :: getString (type_8) << "\", \"";
			error->message() << Token :: getString (type_9) << "\" or \"";
			error->message() << Token :: getString (type_10) << "\" or \"";
			error->message() << Token :: getString (type_11) << "\" was expected." << endLine;
			throw error;
		}
		return getTokenType();
	}
	...
	Token :: Type Lexer :: scan ()
	{
		...
		default :
			...
			error->message() << Token :: getString (type_9) << "\" or \"";
			error->message() << Token :: getString (type_10) << "\" or \"";
			error->message() << Token :: getString (type_11) << "\" or \"";
			error->message() << Token :: getString (type_12) << "\" was expected." << endLine;
			throw error;
		}
		return getTokenType();
	}
	...
	Token :: Type Lexer :: scan ()
	{
		...
		default :
			...
			error->message() << Token :: getString (type_10) << "\" or \"";
			error->message() << Token :: getString (type_11) << "\" or \"";
			error->message() << Token :: getString (type_12) << "\" or \"";
			error->message() << Token :: getString (type_13) << "\" was expected." << endLine;
			throw error;
		}
		return getTokenType();
	}
	...
	Token :: Type Lexer :: scan ()
	{
		...
		default :
			...
			error->message() << Token :: getString (type_11) << "\" or \"";
			error->message() << Token :: getString (type_12) << "\" or \"";
			error->message() << Token :: getString (type_13) << "\" or \"";
			error->message() << Token :: getString (type_14) << "\" was expected." << endLine;
			throw error;
		}
		return getTokenType();
	}
